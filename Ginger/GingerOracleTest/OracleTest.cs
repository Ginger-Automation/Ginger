...
namespace GingerOracleTest
{
    ...
    public class OracleTest
    {
        ...
        public static void ClassInit(TestContext context)
        {
            ...
            param.Add("ConnectionString", "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=illin056)(PORT=1521))(CONNECT_DATA=(sid=ATSDEVDB)));User Id=ATS_MAIN;Password=ATS_MAIN;");
