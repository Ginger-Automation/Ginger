...
namespace Ginger.MenusLib
{
    public static class ResourcesMenu
    {
        ...
        private static Page SharedActivities()
        {
            ...
            SingleItemTreeViewExplorerPage activitiesPage = new SingleItemTreeViewExplorerPage(GingerCore.GingerDicser.GetTermResValue(GingerCore.eTermResKey.Activities), eImageType.Activity, activitiesRoot, saveAllHandler: activitiesRoot.SaveAllTreeFolderItemsHandler, isSaveButtonHidden: true, showTitle: false);
        ...
        private static Page SharedActions()
        {
            ...
            SingleItemTreeViewExplorerPage actionsPage = new SingleItemTreeViewExplorerPage("Actions", eImageType.Action, actionsRoot, actionsRoot.SaveAllTreeFolderItemsHandler, isSaveButtonHidden: true, showTitle: false);
            return actionsPage;
        }
        private static Page SharedVariables()
        {
            ...
            SingleItemTreeViewExplorerPage variablesPage = new SingleItemTreeViewExplorerPage(GingerCore.GingerDicser.GetTermResValue(GingerCore.eTermResKey.Variables), eImageType.Variable, variablesRoot, variablesRoot.SaveAllTreeFolderItemsHandler, isSaveButtonHidden: true, showTitle: false);
        ...
        private static Page GetEnvsPage()
        {
            ...
            SingleItemTreeViewExplorerPage envsPage = new SingleItemTreeViewExplorerPage("Environments", eImageType.Environment, EnvsRoot, EnvsRoot.SaveAllTreeFolderItemsHandler, EnvsRoot.AddItemHandler, isSaveButtonHidden: true, showTitle: false);
        ...
        private static Page Documents()
        {
            ...
            SingleItemTreeViewExplorerPage docsRootPage = new SingleItemTreeViewExplorerPage("Documents", eImageType.File, documentsFolderRoot, saveAllHandler: null, addHandler: null, showTitle: false);
            return docsRootPage;
        }
        ...
        private static Page DataSources()
        {
            ...
            SingleItemTreeViewExplorerPage dataSourcesRootPage = new SingleItemTreeViewExplorerPage("Data Sources", eImageType.DataSource, dataSourcesRoot, dataSourcesRoot.SaveAllTreeFolderItemsHandler, dataSourcesRoot.AddDataSource, showTitle: false);
        ...
        private static Page POMModels()
        {
            ...
            SingleItemTreeViewExplorerPage pomModelPage = new SingleItemTreeViewExplorerPage("Page Objects Models", eImageType.Application, POMsRoot, POMsRoot.SaveAllTreeFolderItemsHandler, POMsRoot.AddPOM, isSaveButtonHidden: true, showTitle: false);
            return pomModelPage;
        }
        ...
        private static Page APIModels()
        {
            ...
            SingleItemTreeViewExplorerPage apiModelPage = new SingleItemTreeViewExplorerPage("API Models", eImageType.APIModel, apiRoot, apiRoot.SaveAllTreeFolderItemsHandler, apiRoot.AddAPIModelFromDocument, isSaveButtonHidden: true, showTitle: false);
            return apiModelPage;
        }
        ...
        private static Page PluginsList()
        {
            ...
            SingleItemTreeViewExplorerPage PluginsRootPage = new SingleItemTreeViewExplorerPage("Plugins", eImageType.PluginPackage, pluginsRoot, saveAllHandler: pluginsRoot.SaveAllTreeFolderItemsHandler, addHandler: pluginsRoot.AddPlugIn, isSaveButtonHidden: true, showTitle: false);
