...
"c:\Program Files (x86)\java\jdk1.6.0_29\bin\jar.exe"  cvfm C:\TFS\GingerDev\GingerNextVer_Dev\Ginger\ExternalAgents\GingerAgent.jar C:\TFS\GingerDev\GingerNextVer_Dev\GingerCore\Drivers\JavaDriverLib\GingerJavaAgent\MANIFEST.MF . .
