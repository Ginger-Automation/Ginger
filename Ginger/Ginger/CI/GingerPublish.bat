...
rem ### Build the GingerSetup project for creating new installtion MSI
...
rem ### Copy the new Ginger installtion MSI to the Support Site Download folder
rem TODO: Need to check the file exsit and from today to make sure the MSI build succeed 
