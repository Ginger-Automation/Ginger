    ...
    public class TreeViewItemBase : TreeViewItemGenericBase
    {
        ...
        public override void AddSourceControlOptions(ContextMenu CM, bool addDetailsOption = true, bool addLocksOption = true)
        {
            if ( WorkSpace.Instance.UserProfile.Solution != null &&  WorkSpace.Instance.UserProfile.Solution.SourceControl != null)
            {
                ...
                if ( WorkSpace.Instance.UserProfile.Solution.SourceControl.IsSupportingGetLatestForIndividualFiles)
                ...
                if ( WorkSpace.Instance.UserProfile.Solution.ShowIndicationkForLockedItems &&  WorkSpace.Instance.UserProfile.Solution.SourceControl.IsSupportingLocks && addLocksOption)
        ...
        {
            SourceControlItemInfoDetails SCIID = SourceControlIntegration.GetInfo( WorkSpace.Instance.UserProfile.Solution.SourceControl, this.NodePath());
        ...
        {
            SourceControlIntegration.UnLock( WorkSpace.Instance.UserProfile.Solution.SourceControl, this.NodePath());
        ...
        private void SourceControlLock(object sender, RoutedEventArgs e)
        {
            ...
            {
                SourceControlIntegration.Lock( WorkSpace.Instance.UserProfile.Solution.SourceControl, this.NodePath(), lockComment);
                mTreeView.Tree.RefreshHeader((ITreeViewItem)this);
            }
        }
        ...
        public void SourceControlUndoChanges(object sender, System.Windows.RoutedEventArgs e)
        {
            if (Reporter.ToUser(eUserMsgKey.SureWantToDoRevert) == Amdocs.Ginger.Common.eUserMsgSelection.Yes)
            {
                ...
                SourceControlIntegration.Revert( WorkSpace.Instance.UserProfile.Solution.SourceControl, this.NodePath());                
        ...
        public void SourceControlGetLatestVersion(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(this.NodePath()))
                ...
                SourceControlIntegration.GetLatest(this.NodePath(),  WorkSpace.Instance.UserProfile.Solution.SourceControl);
        ...
        public override void DuplicateTreeItem(object item)
        {
            ...
            {
                //implement for other item types
                Reporter.ToUser(eUserMsgKey.StaticWarnMessage, "Duplicate operation for this item type was not implemented yet.");
            }
        }
