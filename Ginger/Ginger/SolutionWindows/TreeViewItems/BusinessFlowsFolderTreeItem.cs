    ...
    public class BusinessFlowsFolderTreeItem : NewTreeViewItemBase, ITreeViewItem
    {
        ...
        void ITreeViewItem.SetTools(ITreeView TV)
        {
            ...
            else if (mViewMode == eBusinessFlowsTreeViewMode.ReadWrite)
            {
                ...
                MenuItem importMenu = TreeViewUtils.CreateSubMenu(mContextMenu, "Import", tooltip:"Enterprise Feature");
                ...
                MenuItem exportMenu = TreeViewUtils.CreateSubMenu(mContextMenu, "Export", tooltip: "Enterprise Feature");
