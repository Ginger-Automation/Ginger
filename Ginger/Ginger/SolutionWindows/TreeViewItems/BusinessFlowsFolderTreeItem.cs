    ...
    public class BusinessFlowsFolderTreeItem : TreeViewItemBase, ITreeViewItem
    {
        ...
        void ITreeViewItem.SetTools(ITreeView TV)
        {
            ...
            if (mViewMode == eBusinessFlowsTreeViewMode.ReadWrite)
            {
                ...
                if(App.UserProfile.Solution.AlmType != ALMIntegration.eALMType.QC) TreeViewUtils.AddSubMenuItem(importMenu, "Import ALM Test Set By ID", ALMTSImportById, null, "@ALM_16x16.png");
