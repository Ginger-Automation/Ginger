        ...
        private void SetControls()
        {
            switch (mViewMode)
            {
                case SolutionUpgradePageViewMode.UpgradeSolution:
                    ...
                    GingerCore.GeneralLib.BindingHandler.ObjFieldBinding(DoNotAskAgainChkbox, CheckBox.IsCheckedProperty,  WorkSpace.UserProfile, nameof(UserProfile.DoNotAskToUpgradeSolutions));
                    break;
