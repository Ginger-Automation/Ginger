    ...
    public partial class NewRunSetPage : GingerUIPage
    {
        ...
        private void GingerRunnerHighlight(RunnerPage GRP)
        {
            ...
            if (mCurrentSelectedRunner != null)
            {
                ...
                mCurrentSelectedRunner.xRunnerInfoSplitterBorder.Background = FindResource("$BackgroundColor_Primary") as Brush;
                ...
                {
                    mCurrentSelectedRunner.xRunnerNameTxtBlock.Foreground = FindResource("$BackgroundColor_Primary") as Brush;
                }
            }
        ...
        internal RunnerPage InitRunnerFlowElement(GingerExecutionEngine runner, int index = -1, bool ViewMode = false)
        {
            ...
            GRP.xRunnerInfoSplitterBorder.Background = FindResource("$BackgroundColor_Primary") as Brush;
            GRP.xRunnerNameTxtBlock.Foreground = FindResource("$BackgroundColor_Primary") as Brush;
            mFlowX = mFlowX + 610;
            return GRP;
        }
        ...
        private async Task<int> InitRunnersSection(bool runAsync = true, bool ViewMode = false)
        {
            ...
            foreach (GingerRunner GR in mRunSetConfig.GingerRunners.ToList())
            {
                ...
                this.Dispatcher.Invoke(() =>
                {
                    RunnerPage runnerPage = InitRunnerFlowElement((GingerExecutionEngine)GR.Executor, mRunSetConfig.GingerRunners.IndexOf(GR), ViewMode);
        ...
        private void xBusinessflowListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            foreach (RunnerItemPage currentitem in xBusinessflowsRunnerItemsListView.Items)
            {
                ...
                {
                    currentitem.xItemName.Foreground = FindResource("$BackgroundColor_Primary") as Brush;
                }
            }
        ...
        private void xBusinessflowsActive_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (xBusinessflowsRunnerItemsListView.Items.Count > 0)
            {
                ...
                foreach (RunnerItemPage ri in xBusinessflowsRunnerItemsListView.Items)
                {
                    ...
                    {
                        ((RunnerItemPage)ri).xItemName.Foreground = FindResource("$BackgroundColor_Primary") as Brush;
                    }
                    else
                    {
        ...
        private void xRunnersActive_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (FlowElement rp in fe)
            {
                ...
                if (SetRunnerActive)
                {
                    ((RunnerPage)rp.GetCustomeShape().Content).xRunnerNameTxtBlock.Foreground = FindResource("$BackgroundColor_Primary") as Brush;
                }
                else
                {
