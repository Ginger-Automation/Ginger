...
namespace Ginger.GherkinLib
{
    ...
    public partial class GherkinPage : Page, ITextEditorPage
    {
        ...
        {           
            ...
            folder =  WorkSpace.Instance.UserProfile.Solution.BusinessFlowsMainFolder;
        ...
        public void CreateNewBF(string BizFlowName,string fileName = null, RepositoryFolder<BusinessFlow> targetFolder = null)
        {
            ...
            mBizFlow.ExternalID = GherkinTextEditor.FileName.Replace( WorkSpace.Instance.UserProfile.Solution.Folder, "~") ;                                                
            mBizFlow.Name = BizFlowName;
            mBizFlow.Activities.Clear();
            
            mBizFlow.ContainingFolder = targetFolder.FolderFullPath.Replace( WorkSpace.Instance.UserProfile.Solution.Folder,"~");
            ...
            {                
                ...
                if (a1 == null)
                {
                    ...
                    else
                    {
                        ...
                        a.Active = false;
                        a.TargetApplication =  WorkSpace.Instance.UserProfile.Solution.MainApplication;
        ...
        private Guid GetTagInSolution(string TagName)
        {
            ...
            Guid TagGuid = (from x in  WorkSpace.Instance.UserProfile.Solution.Tags where x.Name == TagName select x.Guid).FirstOrDefault();            
            return TagGuid;
        }
        ...
        private void UpdateBFButton_Click()
        {
            ...
            try
            {
                string externalID = featureFileName.Replace( WorkSpace.Instance.UserProfile.Solution.Folder, "~");
        ...
        public bool Load(string FileName)
        {
            ...
            BFName = FileName.Replace( WorkSpace.Instance.UserProfile.Solution.Folder, "");
            ...
            string externalID = FileName.Replace( WorkSpace.Instance.UserProfile.Solution.Folder, "~");
