...
namespace Ginger.ApplicationModelsLib.POMModels.AddEditPOMWizardLib
{
    ...
    public partial class POMLearnConfigWizardPage : Page, IWizardPage
    {
        ...
        private void SetElementLocatorsSettingsGridView()
        {
            ...
            defView.GridColsView.Add(new GridColView() { Field = nameof(ElementLocator.EnableFriendlyLocator), Header = "Friendly Locator", WidthWeight = 25, HorizontalAlignment = System.Windows.HorizontalAlignment.Center, StyleType = GridColView.eGridColStyleType.CheckBox });
