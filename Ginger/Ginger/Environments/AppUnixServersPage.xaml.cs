    ...
    public partial class AppUnixServersPage : Page
    {
        ...
        private void SetGridView()
        {
            ...
            GridViewDef view = new GridViewDef(GridViewDef.DefaultViewName)
            {
                GridColsView =
            [
                new GridColView() { Field = nameof(UnixServer.Name), WidthWeight = 300 },
                new GridColView() { Field = nameof(UnixServer.Description), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.Host), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.Username), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.Password), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.PrivateKey), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.PrivateKeyPassPhrase), WidthWeight = 150 },
                new GridColView() { Field = nameof(UnixServer.RootPath), WidthWeight = 200, Header = "Root Path" },
            ]
            };
