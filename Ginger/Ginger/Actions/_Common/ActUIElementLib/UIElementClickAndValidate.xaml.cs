        ...
        private Page GetLocateValueEditPage(eLocateBy SelectedLocType)
        {
            ...
            switch (SelectedLocType)
            {
                case eLocateBy.POMElement:
                    ...
                    LocateByPOMElementPage locateByPOMElementPage = new LocateByPOMElementPage((Context)mAct.Context, objValidationElementType, nameof(ActInputValue.Value), objValidationElementLocatorValue, nameof(ActInputValue.Value));
                ...
                default:
                    return new LocateValueEditPage((Context)mAct.Context, objValidationElementLocatorValue, nameof(ActInputValue.Value));
            }
        }
