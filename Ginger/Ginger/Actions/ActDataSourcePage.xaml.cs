...
namespace Ginger.Actions
{
    ...
    public partial class ActDataSourcePage : Page
    {
        ...
        public ActDataSourcePage(ActDSTableElement Act = null)
        {
            ...
            ValueUC.Init((Context)mActDSTblElem.Context, mActDSTblElem.GetOrCreateInputParam(ActInputValue.Fields.Value), true);
        ...
        {            
            ...
            ExcelFilePath.Init((Context)mActDSTblElem.Context, mActDSTblElem, ActDSTableElement.Fields.ExcelPath, true, true, UCValueExpression.eBrowserType.File, "xlsx");
            ExcelSheetName.Init((Context)mActDSTblElem.Context, mActDSTblElem, ActDSTableElement.Fields.ExcelSheetName, true);
        ...
        {
            ValueExpressionEditorPage w = new ValueExpressionEditorPage(mActDSTblElem, ActDSTableElement.Fields.LocateRowValue, (Context)mActDSTblElem.Context);
        ...
        {
            ValueExpressionEditorPage w = new ValueExpressionEditorPage(mActDSTblElem, ActDSTableElement.Fields.QueryValue, (Context)mActDSTblElem.Context);
            w.ShowAsWindow(eWindowShowStyle.Dialog);
        ...
        private void GridVEButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ValueExpressionEditorPage VEEW = new ValueExpressionEditorPage(ADSC, ActDSConditon.Fields.wValue, (Context)mActDSTblElem.Context);
            VEEW.ShowAsWindow();
        }
