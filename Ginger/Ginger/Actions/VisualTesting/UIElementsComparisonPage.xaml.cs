...
namespace Ginger.Actions.VisualTesting
{
    ...
    public partial class UIElementsComparisonPage : Page
    {
        ...
        public UIElementsComparisonPage(ActVisualTesting mAct)
        {
            ...
            BaselineInfoFileUCVE.Init(mAct.Context, mAct.GetOrCreateInputParam(ActVisualTesting.Fields.BaselineInfoFile ), true, true, UCValueExpression.eBrowserType.File, "*", BaselineInfoFileUCVE_FileSelected);
        }
