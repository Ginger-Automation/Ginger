    ...
    public partial class ActTableEditPage : Page
    {
       ...
       public ActTableElement mAct;
        ...
        public ActTableEditPage(ActTableElement Act=null)
        {
            ...
            WhereColumnValue.Init(mAct.Context, mAct.GetOrCreateInputParam(ActTableElement.Fields.WhereColumnValue));
        ...
        private void SetComponents()
        {
            ...
            WhereColumnValue.Init(mAct.Context, ACJT.GetOrCreateInputParam(ActTableElement.Fields.WhereColumnValue));
        }
