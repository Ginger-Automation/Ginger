...
namespace Ginger.Actions
{
    ...
    public partial class ActBrowserElementEditPage : Page
    {
        ...
        public ActBrowserElementEditPage(ActBrowserElement act)
        {
            ...
            ValueUC.Init((Context)mAct.Context, mAct.GetOrCreateInputParam("Value"));
            xLocateValueVE.BindControl((Context)mAct.Context, mAct, Act.Fields.LocateValue);
            ...
            xImplicitWaitVE.BindControl((Context)mAct.Context, mAct, ActBrowserElement.Fields.ImplicitWait);
        ...
        private void SetLocateValueControls()
        {
            ...
            switch (SelectedLocType)
            {
                case eLocateBy.POMElement:
                    ...
                    Page p = new LocateByPOMElementPage((Context)mAct.Context, null, null, mAct, nameof(ActBrowserElement.LocateValue));
        ...
        {
            LocateByPOMElementPage locateByPOMElementPage = new LocateByPOMElementPage((Context)mAct.Context, mAct, null, mAct, nameof(ActBrowserElement.Fields.PomGUID), true);
