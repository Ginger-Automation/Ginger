...
{
    public class MHTHelpFileTreeItem : TreeViewItemBase, ITreeViewItem
    {
        public string FileName { get; set; }
        public string Path { get; set; }
        private ContextMenu mContextMenu = new ContextMenu();
        public MHTHelpFileTreeItem()
        {
        ...
        void ITreeViewItem.SetTools(ITreeView TV)
        {
            ...
            TreeViewUtils.AddMenuItem(mContextMenu, "Open in External Browser", OpenInExternalBrowser, null, "@CreateShorCut_16x16.png");
            mTreeView.AddToolbarTool("@CreateShorCut_16x16.png", "Open in External Browser", OpenInExternalBrowser);
        }

        private void OpenInExternalBrowser(object sender, System.Windows.RoutedEventArgs e)
        {
