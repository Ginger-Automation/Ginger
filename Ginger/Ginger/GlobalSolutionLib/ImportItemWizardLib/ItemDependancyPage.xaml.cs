    ...
    public partial class ItemDependancyPage : Page, IWizardPage
    {
        ...
        private void SetDependantItemsListToImportGridView()
        {
            ...
            [
                ...
                new GridColView() { Field = nameof(GlobalSolutionItem.ItemType), Header = "Item Type", WidthWeight = 50, ReadOnly = true },
                new GridColView() { Field = nameof(GlobalSolutionItem.ItemName), Header = "Item Name", WidthWeight = 50, ReadOnly = true },
                new GridColView() { Field = nameof(GlobalSolutionItem.RequiredFor), Header = "Dependency For", WidthWeight = 50, ReadOnly = true },
                new GridColView() { Field = nameof(GlobalSolutionItem.ItemImportSetting), Header = "Import Setting", WidthWeight = 30, ReadOnly = true },
                new GridColView() { Field = nameof(GlobalSolutionItem.Comments), Header = "Comments", WidthWeight = 120, ReadOnly = true },
                new GridColView() { Field = nameof(GlobalSolutionItem.ItemExtraInfo), Header = "Item Full Path", WidthWeight = 150, ReadOnly = true },
            ]
            };
