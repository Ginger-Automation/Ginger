...
namespace Ginger.AnalyzerLib
{
    ...
    public partial class AnalyzerPage : Page
    {
        ...
        private void RunRunSetConfigAnalyzer(RunSetConfig mRunSetConfig)
        {
                ...
                {
                    issues = AnalyzeGingerRunner.Analyze(GR,  WorkSpace.Instance.UserProfile.Solution.ApplicationPlatforms);
                    AddIssues(issues);
        ...
        private void AnalyzerItemsGrid_RowDoubleClick(object sender, EventArgs e)
        {
            ...
            if (AnalyzerItemsGrid.CurrentItem is AnalyzeAction)
            {
                ...
                actionIssue.SolutionFolder =  WorkSpace.Instance.UserProfile.Solution.Folder.ToUpper();
            ...
            if (AnalyzerItemsGrid.CurrentItem is AnalyzeActivity)
            {
                ...
                //ActivityIssue.SolutionFolder =  WorkSpace.Instance.UserProfile.Solution.Folder.ToUpper();
