...
namespace Ginger.DataSource
{
    ...
    public partial class AddNewDataSourcePage : Page
    {
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            mDSDetails.FileFullPath = mDSDetails.FilePath.Replace("~",  WorkSpace.Instance.UserProfile.Solution.Folder);
            ...
            mDSDetails.FilePath = mDSDetails.FilePath.Replace( WorkSpace.Instance.UserProfile.Solution.Folder, "~");//Pending                       
            ...
            if (File.Exists(mDSDetails.FileFullPath.Replace("~", WorkSpace.Instance.UserProfile.Solution.Folder)) == false)
            {
                byte[] obj = Properties.Resources.GingerDataSource;
                System.IO.FileStream fs = new System.IO.FileStream(mDSDetails.FileFullPath.Replace("~",  WorkSpace.Instance.UserProfile.Solution.Folder), System.IO.FileMode.Create, System.IO.FileAccess.Write);
        ...
        {
            string path = FilePathTextBox.Text.Replace("~",  WorkSpace.Instance.UserProfile.Solution.Folder);
            var dlg = new System.Windows.Forms.OpenFileDialog();
            if (path != "")
                dlg.InitialDirectory = Path.GetDirectoryName(path);
            else
                dlg.InitialDirectory = System.IO.Path.Combine( WorkSpace.Instance.UserProfile.Solution.Folder, "DataSources");
