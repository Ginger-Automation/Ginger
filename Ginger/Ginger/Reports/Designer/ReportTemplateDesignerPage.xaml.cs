...
namespace Ginger.Reports.Designer
{
    ...
    /// </summary>
    public partial class ReportTemplateDesignerPage : Page
    {
        ReportTemplate mReportTemplate;
        ReportPage mReportPage;
        
        public ReportTemplateDesignerPage(ReportTemplate ReportTemplate)
        {
            InitializeComponent();
        ...
        public static ReportPage GetSampleReportPage(string Xaml)
        {
            ...
            GMR.Runners.Add(GR.GingerRunner);
        ...
        private void ReportObjectsTreeView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (path != null)
            {
                ReportXamlTextBox.Focus();
                int selectionIndex = ReportXamlTextBox.SelectionStart;
                ReportXamlTextBox.Text = ReportXamlTextBox.Text.Insert(selectionIndex, path);
                ReportXamlTextBox.SelectionStart = selectionIndex;
                ReportXamlTextBox.SelectionLength = path.Length;
            }
        }
