...
namespace Ginger.Reports
{
    ...
    public partial class ExecutionResultsConfiguration : Page
    {
        ...
        private void SetControls()
        {
            ...
            xSealighsBuildSessionIDTextBox.ValueTextBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsBuildSessionID), nameof(ExecutionLoggerConfiguration.SealightsLabId), "Lab ID or Build Session ID must be provided"));
            xSealighsLabIdTextBox.ValueTextBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsLabId), nameof(ExecutionLoggerConfiguration.SealightsBuildSessionID), "Lab ID or Build Session ID must be provided"));
            xSealightsURLTextBox.ValueTextBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsURL), "Url cannot be empty"));
            xSealighsAgentTokenTextBox.ValueTextBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsAgentToken), "Token cannot be empty"));
            xSealightsTestStageTextBox.ValueTextBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsTestStage), "Test Stage cannot be empty"));
            xSealighsSessionTimeoutTextBox.ValueTextBox.AddValidationRule(new ValidateNumberInputRule());
            xSealighsReportedEntityLevelComboBox.AddValidationRule(new TextBoxEmptyAndDependentValidationRule(_selectedExecutionLoggerConfiguration, nameof(ExecutionLoggerConfiguration.SealightsReportedEntityLevel), "Entity Level cannot be empty"));
