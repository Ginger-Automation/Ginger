...
{
    class JavaRadioButtonTreeItem : JavaElementTreeItem, ITreeViewItem, IWindowExplorerTreeItem
    {
        StackPanel ITreeViewItem.Header()
        {
            return TreeViewUtils.CreateItemHeader(Name, ElementInfo.GetElementTypeImage(eElementType.RadioButton));
        }
        ...
        ObservableList<Act> IWindowExplorerTreeItem.GetElementActions()
        {
            ...
            {
                Description = "Select Radio Button " + Name,
            ...
            list.Add(new ActJavaElement()
            {
                ...
                ControlAction = ActJavaElement.eControlAction.GetState
            });
            return list;
        }
    }
