...
namespace Ginger.Run
{
    ...
    public partial class RunsetOperationsPage : Page
    {
        ...
        {
            if (! WorkSpace.Instance.UserProfile.Solution.ExecutionLoggerConfigurationSetList.Where(x => (x.IsSelected == true)).FirstOrDefault().ExecutionLoggerConfigurationIsEnabled)
            {
        ...
        {
            if (! WorkSpace.Instance.UserProfile.Solution.UseRest && WorkSpace.Instance.UserProfile.Solution.AlmType != GingerCoreNET.ALMLib.ALMIntegration.eALMType.Jira)
            {
