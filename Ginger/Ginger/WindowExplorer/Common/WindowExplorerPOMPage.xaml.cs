...
namespace Ginger.WindowExplorer.Common
{
    ...
    public partial class WindowExplorerPOMPage : Page
    {
        ...
        private void FillPOMS()
        {
            ...
            //string folder = Path.Combine( WorkSpace.Instance.UserProfile.Solution.Folder, @"Applications\" + mApplicationAgent.AppName + @"\Page Objects Models\" );  // TODO: use const or POM helper
