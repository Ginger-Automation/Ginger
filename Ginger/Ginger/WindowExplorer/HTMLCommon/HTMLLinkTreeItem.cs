...
{
    public class HTMLLinkTreeItem : HTMLElementTreeItemBase, ITreeViewItem, IWindowExplorerTreeItem
    {
        StackPanel ITreeViewItem.Header()
        {
            string ImageFileName = "@A_16x16.png";  // TODO:replace to black button style
