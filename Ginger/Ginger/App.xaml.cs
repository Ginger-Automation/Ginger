...
namespace Ginger
{
    ...
    public partial class App : Application
    {
        ...
        public static void FillComboFromEnumVal(ComboBox comboBox, Object EnumValue, List<object> values = null, bool sortValues=true)
        {
            GingerCore.General.FillComboFromEnumObj(comboBox, EnumValue, values, sortValues);            
        }
