...
namespace Ginger.ALM.QC
{
    public partial class QCTestPlanExplorerPage : Page
    {
        ...
        public QCTestPlanExplorerPage()
        {
            ...
            TestPlanExplorerTreeView.TreeTitle2 = "'" + ALMCore.AlmConfig.ALMDomain + " \\ " + ALMCore.AlmConfig.ALMProjectName + "' - Test Plan Explorer";
            TestPlanExplorerTreeView.SetTitleSection();
            //set root item
