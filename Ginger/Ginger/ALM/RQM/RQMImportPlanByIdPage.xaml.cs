...
{
    /// <summary>
    /// Interaction logic for RQMImportPlanByIdPage.xaml
    /// </summary>
    public partial class RQMImportPlanByIdPage : Page
    {
        GenericWindow _pageGenericWin = null;
        private string mImportDestinationPath = string.Empty;
        private bool importStatus;
        private string testPlanId = "";
        public RQMImportPlanByIdPage(string importDestinationPath = "")
        {
            InitializeComponent();
