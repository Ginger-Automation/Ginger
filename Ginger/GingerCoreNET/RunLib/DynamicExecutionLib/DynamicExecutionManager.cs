                ...
                foreach (RunnerExecConfig runnerConfig in dynamicRunsetConfigs.Runners)
                {
                    ...
                    if (runnerConfig.BusinessFlows != null)
                    {
                        foreach (BusinessFlowExecConfig businessFlowConfig in runnerConfig.BusinessFlows)
                        {
                            ...
                            /// For Virtual Business Flows which doesn't exist in solution and are to be created for execution only
                            /// Case : Virtual Runset, Runners & Business Flows
                            /// Cases : Virtual/Non-Virtual Runset and Runners, with Virtual Business Flows
                            ...
                            {
                                /// Business Flow exist in the Solution
                                ...
                                if (businessFlowRun == null)
                                {
                                    try
                                    {
                                        /// BFRun may or may not be already present as the BF may exist in the solution but isn't part of runner
            ...
            if (dynamicRunsetConfigs.Operations != null)
            {
                foreach (OperationExecConfigBase runsetOperationConfig in dynamicRunsetConfigs.Operations)
                {
                    ...
                    else if (runsetOperationConfig is AlmPublishOperationExecConfig)
                    {
                        ...
                        publishToQCRunSetOperation.PublishALMType = publishToALMOperationExecConfig.ALMType.ToString();
