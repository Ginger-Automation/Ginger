...
namespace GingerCore.Drivers.Mobile.Perfecto
{
    ...
    public class PerfectoDriver //: DriverBase
    {
        ...
        //        Dictionary<string, object> params2 = new Dictionary<string, object>();    // Few of Android devices doesnÃ¢â‚¬â„¢t require the swipe operation to make the passcode entry to be visible. If thatÃ¢â‚¬â„¢s the case, comment the swipe function
