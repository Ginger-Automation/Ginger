            ...
            try
                ...
                if (actionType == typeof(ActAccessibilityTesting))
                    ...
                    if (DevicePlatformType == eDevicePlatformType.Android)
                        ...
                        {
                        act.Error = $"ActAccessibilityTesting is not yet implemented for {DevicePlatformType}";
                        }
                    return;
                    }
        ...
        private void ActAccessibilityTestingHandler(ActAccessibilityTesting act)
            ...
            try
                ...
                if (act.GetAccessibilityTarget() == ActAccessibilityTesting.eTarget.Element)
                    ...
                    elementInfo = DevicePlatformType switch
                        {
                            eDevicePlatformType.Android => Driver.FindElement(By.ClassName("android.widget.FrameLayout")),
                            eDevicePlatformType.iOS => Driver.FindElement(By.ClassName("XCUIElementTypeWindow")),
                            _ => Driver.FindElement(By.XPath("//*")) // generic fallback
                            };
                    }
                ...
                switch (act.MobileDeviceAction)
                    ...
                    case ActMobileDevice.eMobileDeviceAction.SimulateBiometrics:
                        ...
                        if (!string.IsNullOrEmpty(biometricsAnswer) && biometricsAnswer != "success")
                            {
                            act.Error = $"Biometrics simulation failed: {biometricsAnswer}";
                            }
                        break;
                        }
