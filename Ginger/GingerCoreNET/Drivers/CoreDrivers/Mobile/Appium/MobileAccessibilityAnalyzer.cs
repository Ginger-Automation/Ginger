...
namespace Amdocs.Ginger.CoreNET.Drivers.CoreDrivers.Mobile.Appium
{
    public class MobileAccessibilityAnalyzer
    {
        ...
        /// <summary>
        /// Builds a meaningful developer-friendly identifier for the element.
        /// Works for both Android and iOS even when resource-id is missing.
        /// </summary>
        private string GetElementIdentifier(XElement element)
        {
            string elementType = element.Name.LocalName; // android.widget.FrameLayout / XCUIElementTypeButton
            string resourceId = element.Attribute("resource-id")?.Value;
            ...
            var parts = new List<string>
    {
        ...
        private List<AccessibilityIssue> AnalyzeXmlElement(XElement element)
        {
            ...
            bool isClickable = string.Equals(element.Attribute("clickable")?.Value, "true", StringComparison.OrdinalIgnoreCase);
            bool isFocusable = string.Equals(element.Attribute("focusable")?.Value, "true", StringComparison.OrdinalIgnoreCase);
            bool isAccessible = string.Equals(element.Attribute("accessible")?.Value, "true", StringComparison.OrdinalIgnoreCase);
            bool isHittable = string.Equals(element.Attribute("hittable")?.Value, "true", StringComparison.OrdinalIgnoreCase);
