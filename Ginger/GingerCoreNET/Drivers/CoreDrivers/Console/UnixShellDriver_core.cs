...
{
    public class UnixShellDriverCore : ConsoleDriverBaseCore
    {
        [UserConfigured]
        ...
        public override string GetCommandText(ActConsoleCommandCore act)
        {
            string cmd = "";
            switch (act.ConsoleCommand)
            {
                case ActConsoleCommandCore.eConsoleCommand.FreeCommand:
                    return GetParameterizedCommand(act);
                case ActConsoleCommandCore.eConsoleCommand.ParametrizedCommand:
                    return GetParameterizedCommand(act);

                case ActConsoleCommandCore.eConsoleCommand.Script:
        ...
        private string GetParameterizedCommand(ActConsoleCommandCore act)
        {
