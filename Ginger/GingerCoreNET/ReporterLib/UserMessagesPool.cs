...
namespace GingerCoreNET.ReporterLib
{
    ...
    {        
        ...
        public static void LoadUserMessgaesPool()
        {
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.CommitedToRevision, new UserMessage(eMessageType.INFO, "Commit Solution", "The changes were commited successfully, Revision: {0}.", MessageBoxButton.OK, MessageBoxResult.None));
