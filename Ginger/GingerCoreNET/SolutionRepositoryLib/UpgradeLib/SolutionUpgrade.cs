...
namespace GingerCoreNET.SolutionRepositoryLib.UpgradeLib
{
    public class SolutionUpgrade
    {
        ...
        //        long currentVersion = Amdocs.Ginger.Common.GeneralLib.ApplicationInfo.ConvertApplicationVersionToLong(Amdocs.Ginger.Common.GeneralLib.ApplicationInfo.ApplicationBackendVersion);
