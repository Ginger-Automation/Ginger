...
namespace Ginger.Reports
{
    ...
    public class ActionReport
    {
        ...
        private string GetValueForDriverWithoutDescrypting(string value)
        {
            ...
            ValueExpression VE = new ValueExpression(mExecutionEnviroment, WorkSpace.Instance.BusinessFlowInContext, WorkSpace.Instance.SolutionRepository.GetAllRepositoryItems<DataSourceBase>(), false, "", false);
