    ...
    public class GingerExecutionEngine : IGingerExecutionEngine
    {
        ...
        */
        ...
        private void ProcessScreenShot(Act act, GingerRunner.eActionExecutorType ActionExecutorType)
        {
            ...
            if ((act.Status == Amdocs.Ginger.CoreNET.Execution.eRunStatus.Failed && !act.AutoScreenShotOnFailure) || mGingerRunner.TakeScreenShot)
            {
                return;
            }
            ...
            {
                if (act.TakeScreenShot || act.Status == Amdocs.Ginger.CoreNET.Execution.eRunStatus.Failed || mGingerRunner.TakeScreenShot)
                {
                    string msg;
                    try
                    {
            ...
            else if (act.TakeScreenShot && act.WindowsToCapture == Act.eWindowsToCapture.DesktopScreen || act.Status == Amdocs.Ginger.CoreNET.Execution.eRunStatus.Failed || mGingerRunner.TakeScreenShot)
            {
                TakeDesktopScreenShotIntoAction(act);
            }
        }
