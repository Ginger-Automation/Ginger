...
namespace Amdocs.Ginger.CoreNET.Run.RunListenerLib
{
    ...
    public abstract class ExecutionLogger
    {
        ...
        public abstract Task<bool> SendExecutionLogToCentralDBAsync(LiteDB.ObjectId runsetId, Guid executionId, eDeleteLocalDataOnPublish deleteLocalData, Guid runsetGuid);
