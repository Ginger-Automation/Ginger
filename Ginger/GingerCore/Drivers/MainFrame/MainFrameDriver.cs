...
namespace GingerCore.Drivers.MainFrame
{
    public class MainFrameDriver : DriverBase, INotifyPropertyChanged, IWindowExplorer
    {
        ...
        public async Task<System.Collections.Generic.List<ElementInfo>> GetVisibleControls(PomSetting pomSetting, ObservableList<ElementInfo> foundElementsList = null, ObservableList<POMPageMetaData> PomMetaData = null, Bitmap ScreenShot = null, ObservableList<UIElementFilter> AutoMapBasicElementTypesList = null)
        {
