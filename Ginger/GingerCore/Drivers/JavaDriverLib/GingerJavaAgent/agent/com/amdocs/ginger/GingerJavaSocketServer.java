...
public class GingerJavaSocketServer 
{
	        ...
	        while (true)
	        {
				...
				while (true)
				{
					...
					{						
						...
						e.printStackTrace();						
						sendResponse(PayLoad.Error(ErrMSG,PayLoad.ErrorCode.Unknown.GetErrorCode()));
					}
				}
	...
	{		
		...
		catch(Exception e)
		{
			...
			PayLoad ResponseERR = PayLoad.Error(ErrMSG,PayLoad.ErrorCode.Unknown.GetErrorCode());
