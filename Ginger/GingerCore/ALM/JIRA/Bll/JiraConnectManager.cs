...
namespace GingerCore.ALM.JIRA
{
    public class JiraConnectManager
    {
        ...
        public bool SetJiraProjectFullDetails()
        {
            ...
            // olego 9/29/20 to be sure that nothing not impacted by change
            ...
            if (selectedProj != null)
            {
                ...
                ALMCore.DefaultAlmConfig.ALMProjectKey = selectedProj.ProjectId.ToString();    // olego 9/29/20
                JiraCore.ALMProjectGuid = selectedProj.Guid;
                // JiraCore.ALMProjectGroupName = selectedProj.Prefix;
                JiraCore.ALMProjectGroupName = selectedProj.ProjectId.ToString();  // olego 9/29/20
                return true;
            }
            return false;
        }
