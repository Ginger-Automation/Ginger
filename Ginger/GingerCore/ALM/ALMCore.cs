...
namespace GingerCore.ALM
{
    ...
    public abstract class ALMCore
    {
        ...
        public virtual void SetALMConfigurations(string ALMServerUrl, bool UseRest, string ALMUserName, string ALMPassword, string ALMDomain, string ALMProject, string ALMProjectKey)
        {
            ...
            if(!String.IsNullOrEmpty(amdocs.ginger.GingerCoreNET.WorkSpace.Instance.UserProfile.Solution.ConfigPackageFolderPath))
                AlmConfig.ALMConfigPackageFolderPath = amdocs.ginger.GingerCoreNET.WorkSpace.Instance.UserProfile.Solution.ConfigPackageFolderPath;
        }
