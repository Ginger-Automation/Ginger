...
namespace GingerCore
{
    ...
    public static class UserMessagesPool
    {
        public static void LoadUserMessgaesPool()
        {
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.WizardCantMoveNextWhileInProcess, new UserMessage(eAppReporterMessageType.WARN, "Process is still running", "Ginger cannot move next until the process will be finished or stopped." + Environment.NewLine + "Please wait for the process to be finished or stop it and then click next.", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.WizardCantMovePrevWhileInProcess, new UserMessage(eAppReporterMessageType.WARN, "Process is still running", "Ginger cannot move previous until the process will be finished or stopped." + Environment.NewLine + "Please wait for the process to be finished or stop it and then click previous.", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.WizardCantFinishWhileInProcess, new UserMessage(eAppReporterMessageType.WARN, "Process is still running", "Ginger cannot move finish wizard until the process will be finished or stopped." + Environment.NewLine + "Please wait for the process to be finished or stop it and then click finish.", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.AskIfToCloseAgent, new UserMessage(eAppReporterMessageType.QUESTION, "Close Agent?", "Close Agent '{0}'?", MessageBoxButton.YesNo, MessageBoxResult.No));
            #endregion POM
