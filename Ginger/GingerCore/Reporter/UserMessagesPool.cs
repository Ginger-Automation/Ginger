...
namespace GingerCore
{
    public enum eUserMsgKeys
    {
        ...
        FindAndReplaceViewRunSetNotSupported, FindAndReplaceViewRunSetNotSupported,
        POMSearchByGUIDFailed, POMElementSearchByGUIDFailed, NoRelevantAgentInRunningStatus
    }
