...
namespace GingerCore
{
    ...
    public static class UserMessagesPool
    {
        public static void LoadUserMessgaesPool()
        {
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.DuplicateRunsetName, new UserMessage(eAppReporterMessageType.WARN, "Duplicate Runset Name", "'{0}' already exists, please use different name", MessageBoxButton.OK, MessageBoxResult.None));
