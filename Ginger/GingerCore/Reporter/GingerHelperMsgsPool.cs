...
namespace GingerCore
{
    ...
    public static class GingerHelperMsgsPool
    {
        public static void LoadGingerHelperMsgsPool()
        {
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.RecommendNewVersion, new GingerHelperMsg(eGingerHelperMsgType.INFO, "Upgrade Required", "Newer version of Ginger exist." + System.Environment.NewLine + "You can download the latest version from https://github.com/Ginger-Automation/Ginger/releases", true, "Upgrade"));
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.ExportItem, new GingerHelperMsg(eGingerHelperMsgType.PROCESS, "Exporting", "Exporting '{0}' {1}"));
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.SaveAll, new GingerHelperMsg(eGingerHelperMsgType.PROCESS, "Saving", "Starting to Save solution..."));
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.NoDirtyItem, new GingerHelperMsg(eGingerHelperMsgType.INFO, "Save All", "No changed items found to be save."));
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.SaveAllSuccess, new GingerHelperMsg(eGingerHelperMsgType.INFO, "Save All", "Items saved successfully."));
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.StartAgent, new GingerHelperMsg(eGingerHelperMsgType.PROCESS, "Starting Agent", "Starting the '{0}' Agent for the '{1}' Application." + System.Environment.NewLine + "Process can be aborted by re-clicking on Start button."));
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.StartAgentFailed, new GingerHelperMsg(eGingerHelperMsgType.INFO,"Start Agent Failed", "'{0}'"));
            ...
            Reporter.GingerHelperMsgsPool.Add(eGingerHelperMsgKey.BusinessFlowConversion, new GingerHelperMsg(eGingerHelperMsgType.PROCESS, "Converting Actions", "Converting the Actions of the '{0}' " + GingerDicser.GetTermResValue(eTermResKey.BusinessFlow)));
