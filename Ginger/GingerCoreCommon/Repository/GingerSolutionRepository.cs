...
namespace Amdocs.Ginger.CoreNET.Repository
{
    public class GingerSolutionRepository
    {
        public static SolutionRepository CreateGingerSolutionRepository()
        {
            ...
            SR.AddItemInfo<ZAPConfiguration>("*.Ginger.Configuration.xml", SolutionRepository.cSolutionRootFolderSign + "Configurations" + Path.DirectorySeparatorChar + "ZAPConfiguration", true, "ZAP Configuration", PropertyNameForFileName: nameof(ZAPConfiguration.Name));
