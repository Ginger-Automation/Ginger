            ...
            get
            {
                if (mCommonApplicationDataFolderPath == null)
                {
                    try
                    {
                        ...
                        string folderPath = OperatingSystem.IsMacOS() ? Environment.GetFolderPath(Environment.SpecialFolder.Personal) : Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData, Environment.SpecialFolderOption.Create);
        ...
        public static string LocalUserApplicationDataFolderPath
        {
            get
            {
                if (mAppDataFolder == null)
                {
                    ...
                    {
                        // DoNotVerify so on Linux it will not return empty 
                        string appDataFolder = OperatingSystem.IsMacOS() ? Environment.GetFolderPath(Environment.SpecialFolder.Personal) : Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData, Environment.SpecialFolderOption.DoNotVerify);
