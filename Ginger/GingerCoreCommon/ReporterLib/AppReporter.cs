...
//        public static void OnReportEvent(eAppReportType reportType, string reportMessage, eLogLevel reportLogLevel = eLogLevel.INFO, Exception reportExceptionToRecord = null, bool logOnlyOnDebugMode = false, eMessageType reportMessageType = eMessageType.INFO)
//        {
...
//        public static void ToLog(eLogLevel logLevel, string logMessage, Exception exceptionToRecord = null, bool logOnlyOnDebugMode=false)
//        {
...
//        public static void ToUser(eMessageType reportMessageType, string message)
//        {
