...
namespace Amdocs.Ginger.Common
{
    public enum eUserMsgKeys
    {
        ...
        POMWizardFailedToLearnElement, POMWizardReLearnWillDeleteAllElements, POMDeltaWizardReLearnWillEraseModification , WizardCantMoveWhileInProcess, POMDriverIsBusy, FindAndReplaceViewRunSetNotSupported,
    ...
    {        
        ...
        public static void LoadUserMessgaesPool()
        {
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.RecommendNewVersion, new UserMessage(eMessageType.WARN, "Upgrade required", "You are not using the latest version of Ginger. Please go to http://cmitechint1srv:8089/ to get the latest build.", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.GitUpdateState, new UserMessage(eMessageType.INFO, "Update Solution", "The solution was updated successfully, Update status: {0}.", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.SourceControlChkInConflictHandled, new UserMessage(eMessageType.QUESTION, "Check-In Results", "The check in process ended, please notice that conflict was identified during the process and may additional check in will be needed for pushing the conflict items." + Environment.NewLine + Environment.NewLine + "Do you want to do another check-in?", MessageBoxButton.YesNo, MessageBoxResult.No));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.SourceControlGetLatestConflictHandledFailed, new UserMessage(eMessageType.WARN, "Get Latest Results", "Get latest process encountered conflicts which must be resolved for successful Solution loading", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.GingerKeyNameError, new UserMessage(eMessageType.ERROR, "InValid Ginger Key Name", "The Ginger Key Name cannot be Duplicate or NULL. Please fix before continuing.", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.MissingNewColumn, new UserMessage(eMessageType.WARN, "Missing Column Details", "The new Column {0} is missing.", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.AskIfToLoadExternalFields, new UserMessage(eMessageType.QUESTION, "Load/Refresh ALM External Fields", "The activity will run in the background for several hours." + Environment.NewLine +"Please do not close Ginger until operation is complete."+ Environment.NewLine + "Would you like to continue?", MessageBoxButton.YesNo, MessageBoxResult.No));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.FileNotExist, new UserMessage(eMessageType.WARN, "XML File Not Exist", "XML File has not been found on the spesified path, either deleted or been re-named on the defeine XML path", MessageBoxButton.OK, MessageBoxResult.None));

            Reporter.UserMessagesPool.Add(eUserMsgKeys.FilterNotBeenSet, new UserMessage(eMessageType.QUESTION, "Filter Not Been Set", "No filtering criteria has been set, Retreiving all elements from page can take long time to complete, Do you want to continue?", MessageBoxButton.OKCancel, MessageBoxResult.Cancel));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.RetreivingAllElements, new UserMessage(eMessageType.QUESTION, "Retreiving all elements", "Retreiving all elements from page can take long time to complete, Do you want to continue?", MessageBoxButton.OKCancel, MessageBoxResult.Cancel));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.ClickElementAgain, new UserMessage(eMessageType.INFO, "Please Click" ,"Please click on the desiered element again", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.AskIfShareVaribalesInRunner, new UserMessage(eMessageType.QUESTION, "Share Variables", "Are you sure you want to share selected Variable Values to all the similar Business Flows and Activities across all Runners?", MessageBoxButton.YesNo, MessageBoxResult.No));            
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.AskIfToUndoChanges, new UserMessage(eMessageType.QUESTION, "Undo Changes?", "Do you want to undo changes (in case changes were done) and close?", MessageBoxButton.YesNo, MessageBoxResult.No));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.SourceControlItemAlreadyLocked, new UserMessage(eMessageType.INFO, "Source Control File Locked", "The file is already locked" + Environment.NewLine + "Please do Get info for more details", MessageBoxButton.OK, MessageBoxResult.OK));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.SoruceControlItemAlreadyUnlocked, new UserMessage(eMessageType.INFO, "Source Control File not Locked", "The file is not locked" + Environment.NewLine + "Please do Get info for more details", MessageBoxButton.OK, MessageBoxResult.OK));            
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.ExportFailed, new UserMessage(eMessageType.ERROR, "Export Failed", "Error Occurred while exporting the {0}: {1}", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.ExportDetails, new UserMessage(eMessageType.INFO, "Export Details", "Export execution ended successfully", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.ParamExportMessage, new UserMessage(eMessageType.QUESTION, "Param Export to Data Source", "Special Characters will be removed from Parameter Names while exporting to Data Source. Do you wish to Continue?", MessageBoxButton.YesNo, MessageBoxResult.No));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.CreateTableError, new UserMessage(eMessageType.ERROR, "Create Table Error", "Failed to Create the Table. Error: {0}", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.MappedtoDataSourceError, new UserMessage(eMessageType.ERROR, "Output Param Mapping Error ", "Failed to map the Output Params to Data Source", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.InvalidDataSourceDetails, new UserMessage(eMessageType.ERROR, "Invalid Data Source Details", "The Data Source Details provided are Invalid.", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.DuplicateRunsetName, new UserMessage(eMessageType.WARN, "Duplicate Runset Name", "'{0}' already exists, please use different name", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.ALMDefectsUserInOtaAPI, new UserMessage(eMessageType.INFO, "ALM Defects Valid for Rest API only", "You are in ALM Ota API mode, Please change to Rest API", MessageBoxButton.OK, MessageBoxResult.None));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.POMDeltaWizardReLearnWillEraseModification, new UserMessage(eMessageType.WARN, "Re-Compare Elements", "Re-Compare Elements will delete all existing Elements modification and selection" + Environment.NewLine + "Do you want to continue?", MessageBoxButton.YesNo, MessageBoxResult.No));
            ...
            Reporter.UserMessagesPool.Add(eUserMsgKeys.POMCannotDeleteAutoLearnedElement, new UserMessage(eMessageType.WARN, "Cannot Delete Auto Leared Element", "The Element you are trying to delete has been leared automatically from page and cannot be deleted", MessageBoxButton.OK, MessageBoxResult.OK));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.WizardCantMoveWhileInProcess, new UserMessage(eMessageType.WARN, "Process is Still Running", "Move '{0}' until the process will be finished or stopped." + Environment.NewLine + "Please wait for the process to be finished or stop it and then retry.", MessageBoxButton.OK, MessageBoxResult.None));
            Reporter.UserMessagesPool.Add(eUserMsgKeys.AskIfToCloseAgent, new UserMessage(eMessageType.QUESTION, "Close Agent?", "Close Agent '{0}'?", MessageBoxButton.YesNo, MessageBoxResult.No));            
