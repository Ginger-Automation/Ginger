...
namespace Amdocs.Ginger.Common
{
    ...
    public static class StatusMsgsPool
    {
        public static void LoadStatusMsgsPool()
        {
            ...
            Reporter.StatusMsgsPool.Add(eStatusMsgKey.ALMTestSetMap, new StatusMsg(eStatusMsgType.PROCESS, "Mapping To ALM Wizard upload" , "Prepare Data for Map To ALM Wizard"));
