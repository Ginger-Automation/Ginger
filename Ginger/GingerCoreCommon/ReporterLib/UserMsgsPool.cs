...
namespace Amdocs.Ginger.Common
{
    public enum eUserMsgKey
    {
        ...
        ElementNotExistInPOM, UpdatePOM,
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ElementNotExistInPOM, new UserMsg(eUserMsgType.QUESTION, "Element Not Found", "'{0}' does not exist in selected Page Object Model - '{1}'" + Environment.NewLine + "Do you want to add this Element to POM ?", eUserMsgOption.YesNo, eUserMsgSelection.Yes));
            Reporter.UserMsgsPool.Add(eUserMsgKey.UpdatePOM, new UserMsg(eUserMsgType.QUESTION, "Updated Element Found", "An updated version of Page Object Model Element '{0}' detected." + Environment.NewLine + "Do you want to update existing POM ?", eUserMsgOption.YesNo, eUserMsgSelection.Yes));
