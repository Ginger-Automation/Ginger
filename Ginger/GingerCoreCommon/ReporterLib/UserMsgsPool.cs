...
namespace Amdocs.Ginger.Common
{
    ...
    {        
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.QcCheckRestApi, new UserMsg(eUserMsgType.WARN, "QC/ALM Check RestApi", "CheckBox Use RestAPI Should be 'Unchecked for ALM 11' and 'Checked for ALM 12 & above'" + System.Environment.NewLine + "Do you want to change ALM connection settings?", eUserMsgOption.YesNo, eUserMsgSelection.No));
