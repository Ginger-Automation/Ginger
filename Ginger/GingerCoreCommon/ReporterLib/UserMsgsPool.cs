...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.WarnAddLegacyAction, new UserMsg(eUserMsgType.WARN, "Legacy Action Warnning", "This Action is part of the Legacy Actions which will be depecrated soon and not recommanded to be used anymore." + Environment.NewLine + "Do you still intrested adding it?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            Reporter.UserMsgsPool.Add(eUserMsgKey.WarnAddLegacyActionAndOfferNew, new UserMsg(eUserMsgType.WARN, "Legacy Action Warnning", "This Action is part of the Legacy Actions which will be depecrated soon and not recommanded to be used anymore." + Environment.NewLine + "Do you prefer to add the replacment Action ({0}) for it?", eUserMsgOption.YesNoCancel, eUserMsgSelection.Yes));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.DeleteTreeFolderAreYouSure, new UserMsg(eUserMsgType.WARN, "Delete Foler", "Are you sure you want to delete the '{0}' folder and all of it content?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.FoundDuplicateAgentsInRunSet, new UserMsg(eUserMsgType.ERROR, "Found Duplicate Agents in " + GingerDicser.GetTermResValue(eTermResKey.RunSet), "Agent name '{0}' is defined more than once in the Run Set", eUserMsgOption.OK, eUserMsgSelection.None));

            Reporter.UserMsgsPool.Add(eUserMsgKey.FileNotExist, new UserMsg(eUserMsgType.WARN, "XML File Not Exist", "XML File has not been found on the spesified path, either deleted or been re-named on the defeine XML path", eUserMsgOption.OK, eUserMsgSelection.None));

            Reporter.UserMsgsPool.Add(eUserMsgKey.FilterNotBeenSet, new UserMsg(eUserMsgType.QUESTION, "Filter Not Been Set", "No filtering criteria has been set, Retreiving all elements from page can take long time to complete, Do you want to continue?", eUserMsgOption.OKCancel, eUserMsgSelection.Cancel));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.RetreivingAllElements, new UserMsg(eUserMsgType.QUESTION, "Retreiving all elements", "Retreiving all elements from page can take long time to complete, Do you want to continue?", eUserMsgOption.OKCancel, eUserMsgSelection.Cancel));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ClickElementAgain, new UserMsg(eUserMsgType.INFO, "Please Click", "Please click on the desiered element again", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.AskIfShareVaribalesInRunner, new UserMsg(eUserMsgType.QUESTION, "Share Variables", "Are you sure you want to share selected Variable Values to all the similar Business Flows and Activities across all Runners?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.FileOperationError, new UserMsg(eUserMsgType.ERROR, "Error occured during file operation", "{0}", eUserMsgOption.OK, eUserMsgSelection.None));
            Reporter.UserMsgsPool.Add(eUserMsgKey.FolderOperationError, new UserMsg(eUserMsgType.ERROR, "Error occured during folder operation", "{0}", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.MissingTargetApplication, new UserMsg(eUserMsgType.ERROR, "Missing target ppplication", "{0}", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.RunSetReloadhWarn, new UserMsg(eUserMsgType.WARN, "Reload " + GingerDicser.GetTermResValue(eTermResKey.RunSet), "Reload process will cause all un-saved changes to be lost." + Environment.NewLine + Environment.NewLine + " To continue wite reload?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ExportedExecDetailsToALMIsInProcess, new UserMsg(eUserMsgType.INFO, "Export Execution Details", "Please Wait, Exporting Execution Details is inprocess.", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.MissedMandatotryFields, new UserMsg(eUserMsgType.INFO, "Profiles Saving", "Please, populate value for mandatotry field '{0}' of '{1}' Defect Profile", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.POMWizardFailedToLearnElement, new UserMsg(eUserMsgType.WARN, "Learn Elements Failed", "Error occured while learning the elements." + Environment.NewLine + "Error Details:" + Environment.NewLine + "'{0}'", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.POMCannotDeleteAutoLearnedElement, new UserMsg(eUserMsgType.WARN, "Cannot Delete Auto Leared Element", "The Element you are trying to delete has been leared automatically from page and cannot be deleted", eUserMsgOption.OK, eUserMsgSelection.OK));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ShareVariableNotSelected, new UserMsg(eUserMsgType.INFO, "Info Message", "Please select the variables to share.", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.VisualTestingFailedToDeleteOldBaselineImage, new UserMsg(eUserMsgType.WARN, "Creating New Baseline Image", "Error while tyring to create and save new Baseline Image.", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.BusinessFlowUpdate, new UserMsg(eUserMsgType.INFO, "Business Flow", "BusinessFlow '{0}' {1} Sucessfully", eUserMsgOption.OK, eUserMsgSelection.None));
