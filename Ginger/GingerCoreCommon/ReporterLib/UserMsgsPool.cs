...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.SourceControlChkInConfirmtionForLocalFiles, new UserMsg(eUserMsgType.QUESTION, "Check-In Changes", "Check-in changes will effect all project users, are you sure you want to continue and check in those {0} local file changes?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            Reporter.UserMsgsPool.Add(eUserMsgKey.SourceControlChkInConfirmtionForLocalCommit, new UserMsg(eUserMsgType.QUESTION, "Check-In Changes", "Check-in changes will effect all project users, are you sure you want to continue and check in those {0} Local Commit changes?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            Reporter.UserMsgsPool.Add(eUserMsgKey.SourceControlChkInConfirmtionForLocalCommitAndFiles, new UserMsg(eUserMsgType.QUESTION, "Check-In Changes", "Check-in changes will effect all project users, are you sure you want to continue and check in those {0} local file changes and {1} Local Commit ?", eUserMsgOption.YesNo, eUserMsgSelection.No));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.MissingApplicationPlatform, new UserMsg(eUserMsgType.WARN, "Missing Application Platform Info", $"The default Application Platform Info is missing, please go to Solution level to add at least one {GingerDicser.GetTermResValue(eTermResKey.TargetApplication)}", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ApplicationAgentNotMapped, new UserMsg(eUserMsgType.WARN, $"Agent Not Mapped to {GingerDicser.GetTermResValue(eTermResKey.TargetApplication)}", $"The Agent Mapping for {GingerDicser.GetTermResValue(eTermResKey.TargetApplication)} '{0}' , Please map Agent.", eUserMsgOption.OK, eUserMsgSelection.None));
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.MissingTargetApplication, new UserMsg(eUserMsgType.ERROR, "Missing " + GingerDicser.GetTermResValue(eTermResKey.TargetApplication), "{0}", eUserMsgOption.OK, eUserMsgSelection.None));
