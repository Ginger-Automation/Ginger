...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.WarnAddLegacyActionAndOfferNew, new UserMsg(eUserMsgType.WARN, "Legacy Action Warning", "This Action is part of the Legacy Actions which will be desecrated soon and not recommended to be used anymore." + Environment.NewLine + "Do you prefer to add the replacement Action ({0}) for it?", eUserMsgOption.YesNoCancel, eUserMsgSelection.Yes));
