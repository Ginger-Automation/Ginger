...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ShareApplicationToEnvironment, new UserMsg(eUserMsgType.QUESTION, "Add Application All Environment", "Do you want to publish this application to all the existing environments" , eUserMsgOption.YesNo, eUserMsgSelection.None));
