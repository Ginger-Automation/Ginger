...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.AddActivitiesToSharedRepositoryForBPMNConversion, new UserMsg(eUserMsgType.QUESTION, Caption: "Add Missing Activitiess to Shared Repository", Message: "All the activities must be added to shared repository before generating BPMN.\nWould you like to add now?", eUserMsgOption.YesNoCancel, eUserMsgSelection.Yes));
            #endregion
