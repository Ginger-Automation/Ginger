...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ShadowRootExists, new UserMsg(eUserMsgType.INFO, "Shadow DOM Element Detected", "This element exists under a shadow root, you will have to manually add the action(s) to locate this element. Please look into 'Switch To Shadow DOM' operation in Browser Action", eUserMsgOption.OK , eUserMsgSelection.OK));
