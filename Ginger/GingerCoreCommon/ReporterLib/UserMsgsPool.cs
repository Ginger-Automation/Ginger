...
namespace Amdocs.Ginger.Common
{
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.AskIfWantsToChangeeRepoItem2, new UserMsg(eUserMsgType.WARN, "Change Repository Item", "The item '{0}' may be used in many places." + Environment.NewLine + Environment.NewLine + "Are you sure you want to {1} it?" + Environment.NewLine + Environment.NewLine + "Note: Changes will reflect in linked instances of this item", eUserMsgOption.YesNo, eUserMsgSelection.No));
