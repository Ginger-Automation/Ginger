...
namespace Amdocs.Ginger.Common
{
    public enum eUserMsgKey
    {
        ...
        AskToSelectVariable, VariablesAssignError, SetCycleNumError, VariablesParentNotFound, CantStoreToVariable, ListOutOfBounds,
    ...
    public static class UserMsgsPool
    {
        public static void LoadUserMsgsPool()
        {
            ...
            Reporter.UserMsgsPool.Add(eUserMsgKey.ListOutOfBounds, new UserMsg(eUserMsgType.ERROR, GingerDicser.GetTermResValue(eTermResKey.Variables) + " Out Of Bounds Error", "Failed to get Value from " + GingerDicser.GetTermResValue(eTermResKey.Variables) + " at the index currently specified." + Environment.NewLine + "Error Details: '{0}'.", eUserMsgOption.OK, eUserMsgSelection.None));
