...
namespace GingerCoreNETUnitTests.SolutionTestsLib
{
    ...
    public class RepositorySerializerTest
    {
        ...
        {
            //Arrange
            WorkSpace.Instance.OpenSolution(Path.Combine(TestResources.GetTestResourcesFolder(@"Solutions"), "BasicSimple"), Amdocs.Ginger.Common.EncryptionHandler.GetDefaultKey());
