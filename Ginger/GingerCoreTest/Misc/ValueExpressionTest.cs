    ...
    public class ValueExpressionTest
    {
        ...
        public void RegGroup1()
        {
            ...
            ValueExpression VE = new ValueExpression(mEnv, mBF)
            {
                ...
                Value = @"{RegEx Fun=1 Pat=access code is (\w{8}) P1=Your en.mi.univisionmobile.com access code is 4gT3hDEh. This code is case sensitive and expires in 72 hours.Ã‚Â }"
            };
