...
//{
//    [Ignore]  // temp until we have solution for long path
//    [TestClass]
//    [Level1]
...
//            // RS.AddClassesFromAssembly(typeof(MyRepositoryItem).Assembly);

//            // change from static to obj
...
//            //SR = Solution.CreateNewSolution("SR Test Temp", TempSolutionFolder);

//            // Then we close it
//            // mSolutionRepository.Close(); // ???!!!

//            //Then we open it for testing
//            //mSolutionRepository = SolutionRepository.GetSolutionRepository(TempSolutionFolder, RepositorySerializerInitilizer2.GetNewRepositoryFolders);
